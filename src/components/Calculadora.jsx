...
export function Calculadora() {
    ...
    return (
        ...
        <div className="flex h-screen justify-top items-center">

                <div className="p-6 bg-gray-300 w-56 rounded-lg border   border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <h5 className="text-3xl font-bold text-center mb-5 text-gray-900 dark:text-white">Cassio</h5>
                ...
                <div>
                    <div className="grid gap-2 grid-cols-4 text-blue-50">
                        ...
                        <button type='button' value="+" onClick={logica} className={styleButton.operator}>+</button>
                        <button type='button' value="delete" onClick={logica} className={styleButton.operator}>C</button>
